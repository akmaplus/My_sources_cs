...
namespace b2
{
    class Vertex3d
    {
        ...
        //статический метод - как функци€ - действует дл€ типа в целом
    ...
    class Program
    {
        ...
        {
            Vertex3d a = new Vertex3d(0, 0, 1);     //создаем экзмепл€р класса - объект

            Vertex3d b = new Vertex3d(1, 0, 1);     //создаем экзмепл€р класса - объект
